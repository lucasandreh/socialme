...
describe('Controller profile de usuário logado', () => {
  ...
  it('Deve ser capaz de retornar profile de usuário logado', async () => {
  ...
  it('Deve retornar erro caso o perfil do usuário não exista', async () => {
    ...
    expect(response.body.message).toEqual('O perfil do usuário não existe');
